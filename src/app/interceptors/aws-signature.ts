...
export class AwsSignature {
     ...
     */
    generateSignature(input: AwsSignatureInputData, currentDate: Date = new Date()): AwsSignatureOutputData {
        if (!input) {
            return new AwsSignatureOutputData();
        }
        ...
        let awsSignatureOutput = new AwsSignatureOutputData();
        awsSignatureOutput.contentType = input.contentType;
        awsSignatureOutput.xAmzDate = amzDate;
        awsSignatureOutput.authorization = authorizationHeader;
        return awsSignatureOutput;
    }
